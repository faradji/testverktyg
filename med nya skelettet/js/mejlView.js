$(document).ready(function(){
  ...
  $('.list-group doneTestsList col-sm-3').append(`<div class="list-group studClassesMailChoice col-sm-3">
  ...
  <button type="button" class="list-group-item">Vestibulum at eros</button>
	...
	$('.list-group teachReadtest col-sm-8').append(`<ul class="list-group tempMailAdressesList col-sm-8">
